...
CREATE TABLE IF NOT EXISTS tarifas (
    ...
    valor_primera_hora DECIMAL(10,2) NOT NULL,
    valor_hora_2_a_12 DECIMAL(10,2) NOT NULL,
    valor_hora_13_a_168 DECIMAL(10,2) NOT NULL,
    valor_hora_169_mas DECIMAL(10,2) NOT NULL,
...
-- =====================================================================
-- 2. TABLAS DE VEHÍCULOS Y OPERACIÓN (Estructura Unificada a VARCHAR(20))
-- =====================================================================

CREATE TABLE IF NOT EXISTS vehiculos (
    placa_vehiculo VARCHAR(20) PRIMARY KEY, -- Corregido a 20 desde el inicio
    modelo VARCHAR(50),
    marca VARCHAR(50)
);
...
CREATE TABLE IF NOT EXISTS mensualidades (
    ...
    placa_vehiculo VARCHAR(20) NOT NULL, -- Debe coincidir con vehiculos
    id_usuario INT NOT NULL,
