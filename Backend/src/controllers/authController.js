...
exports.registerCliente = async (req, res) => {
  ...
  try {
    // 1. Validar si el correo ya existe en clientes o usuarios
    ...
    // 3. Insertar el vehículo si no existe
    await db.query('INSERT IGNORE INTO vehiculos (placa_vehiculo) VALUES (?)', [placaVehiculo]);

    // 4. Insertar en la tabla clientes con tus campos compuestos y los nuevos creados
    ...
    // 5. Crear mensualidad inicial de prueba
